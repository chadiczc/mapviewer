...
//Command to convert a CAD file to GeoJSON
//dwgread.exe "C:\Users\esd_gchaaban\Desktop\Projects\TDP\Document\PWA_TDP Template_V2.dwg" -O GeoJSON -o "C:\Users\esd_gchaaban\Desktop\experimental projects\koop\libs\a.json"
...
Model.prototype.getData = function (req, callback) {
  ...
  fs.readFile('./a.geojson', 'utf8', (err, data) => {
    if (err) {
      console.error(err);
      return;
    }
